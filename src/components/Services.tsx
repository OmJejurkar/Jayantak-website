...
const services = [
  {
    ...
    description: "We specialize in planning and executing strategic political campaigns that maximize voter engagement and success rates.",
  },
  {
    icon: <Camera className="w-8 h-8 text-orange-500" />, 
    title: "Photography",
    description: "Our professional photography services ensure high-quality visuals for personal, corporate, and commercial needs.",
  },
  {
    icon: <Calendar className="w-8 h-8 text-orange-500" />, 
    title: "Event Planning",
    description: "We provide end-to-end event planning services to make your corporate and private events a success.",
  },
  {
    icon: <Globe className="w-8 h-8 text-purple-500" />, 
    title: "Digital Marketing",
    description: "Our result-driven digital marketing strategies enhance online visibility and customer engagement.",
  },
  {
